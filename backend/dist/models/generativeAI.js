...
var GenerativeAIModel = /*#__PURE__*/function () {
  function GenerativeAIModel() {
    _classCallCheck(this, GenerativeAIModel);
    // Initialize the GoogleGenerativeAI instance with the API key from environment variables
    this.genAI = new GoogleGenerativeAI(process.env.API_KEY);
  }
  return _createClass(GenerativeAIModel, [{
    key: "generateContent",
    value: function () {
      var _generateContent = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(prompt) {
        var model, result, text;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 15:
              ...
              console.error("Error generating content:", _context.t0);
              throw _context.t0;
            case 19:
            case "end":
